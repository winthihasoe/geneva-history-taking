...
@section('title', 'Add History')
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#elder" role="tab" aria-controls="home"
            aria-selected="true">Elder History Taking</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#child" role="tab" aria-controls="profile"
            aria-selected="false">Child History Taking</a>
        </li>
    </ul>

    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="elder" role="tabpanel" aria-labelledby="home-tab">
            <div class="container">
        ...
        <div class="tab-pane fade" id="child" role="tabpanel" aria-labelledby="profile-tab">
            <div class="container">
                    <div class="row justify-content-center">
