...
@section('title', 'Edit History')
    <div class="container">
        <div class="row justify-content-center">
            ...
            <form class="form-group border border-light border-round p-5 shadow-3-strong mt-4" action="{{route('admin.update_history',$patient->id)}}" method="post">
            @csrf
               ...
               {{-- duty  --}}
                ...
                {{-- Cancel button  --}}
                <a class="btn btn-danger btn-block my-2" href="{{route('admin.singlePatient',$patient->id)}}">Cancel</a>
